...
namespace Isogeo.Build.Tasks
{
    ...
    public class FxCop: ToolTask
    {
        ...
        public bool DirectOutputToConsole
        {
            get
            {
                return _directOutputToConsole;
            }
            set
            {
                _directOutputToConsole=value;
            }
        }
        ...
        public ITaskItem[] DependencyDirectories
        {
            get
            {
                return _dependencyDirectories;
            }
            set
            {
                _dependencyDirectories=value;
            }
        }
        ...
        public string ConsoleXslFileName
        {
            get
            {
                return _consoleXslFileName;
            }
            set
            {
                _consoleXslFileName=value;
            }
        }
        ...
        public string AnalysisReportFileName
        {
            get
            {
                return _analysisReportFileName;
            }
            set
            {
                _analysisReportFileName=value;
            }
        }
        ...
        public string OutputXslFileName
        {
            get
            {
                return _outputXslFileName;
            }
            set
            {
                _outputXslFileName=value;
            }
        }
        ...
        public bool IncludeSummaryReport
        {
            get
            {
                return _includeSummaryReport;
            }
            set
            {
                _includeSummaryReport=value;
            }
        }
        ...
        protected override string GenerateFullPathToTool()
        {
            if (string.IsNullOrEmpty(ToolPath))
            {
                ...
                fxCopPath=Path.Combine(fxCopPath, @"Microsoft FxCop 1.36");

                try
                {
                    using (RegistryKey buildKey=Registry.ClassesRoot.OpenSubKey(@"FxCop.Project.9.0\shell\Open\command"))
                    {
                        if (buildKey==null)
                        {
        ...
        protected override string GenerateCommandLineCommands()
        {
            ...
            if (Dictionary!=null)
            {
                _programArguments.AppendFormat("/dic:\"{0}\" ", Dictionary.ItemSpec);
            }
